...
<h3>🚀 About Me</h3>
<ul>
  <li>🌱 I’m currently <strong>a student at Institut Teknologi Sepuluh Nopember (ITS)</strong></li>
  <li>💻 I can build websites using <strong>PHP, HTML, CSS, & JS</strong></li>
  <li>🎮 I develop games using <strong>Python, Unity, and C#</strong></li>
  <li>⚡ Fun fact: <strong>I wear a watch while sleeping — just to track how much time I <em>don’t</em> spend coding 😄</strong></li>
</ul>
